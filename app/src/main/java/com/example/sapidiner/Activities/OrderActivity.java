...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* u.setFirstName("kiss"); u.setLastName("anna");u.setPhoneNumber("0756");u.setEmail("jfb"); u.setUserType(0);u.setUserId("CrIw1hWlVmXmyAXs8nIYfnuYCTR2");
        myorder.add(o1);
        myorder.add(o2);
        myorder.add(o3);
        Orders order = new Orders (u, myorder, 14.0);
